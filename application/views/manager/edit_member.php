            ...
            <div class="span12 padding10 bg-grayLighter">
                ...
                <form method="post" action="<?php echo current_url(); ?>">
                    ...
                    <div class="input-control text<?php $error = form_error('nama'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="Nama" name="nama" value="<?php echo set_value('nama', $member->nama); ?>">
                    ...
                    <div class="input-control text<?php $error = form_error('identitas'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="No Identitas" name="identitas" value="<?php echo set_value('identitas', $member->no_identitas); ?>">
                        <button class="btn-clear" tabindex="-1" type="button"></button>
                        <?php echo $error; ?>
                    </div>
                    ...
                    <div class="input-control text<?php $error = form_error('pekerjaan'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="Pekerjaan" name="pekerjaan" value="<?php echo set_value('pekerjaan', $member->pekerjaan); ?>">
                        <button class="btn-clear" tabindex="-1" type="button"></button>
                        <?php echo $error; ?>
                    </div>
                    ...
                    <div class="input-control text<?php $error = form_error('no_telp'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="Nomor Telepon" name="no_telp" value="<?php echo set_value('no_telp', $member->no_telp); ?>">
                        <button class="btn-clear" tabindex="-1" type="button"></button>
                        <?php echo $error; ?>
                    </div>
                    <lable>Kota</lable>
                    <div class="input-control text<?php $error = form_error('kota'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="Kota" name="kota" value="<?php echo set_value('kota', $member->kota); ?>">
                        <button class="btn-clear" tabindex="-1" type="button"></button>
                        <?php echo $error; ?>
                    </div>
                    <input type="submit" value="Submit" name="edit_member" class="bg-cyan fg-white" />
                </form>
            </div>
        </div>
    </div>
