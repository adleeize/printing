        ...
        <div class="grid no-margin">
            <div class="row no-margin">
                <div class="span8 padding20 nrp">
                    <a href="<?php echo site_url('manager'); ?>" class="shortcut">
                        <i class="icon-cart"></i>
                        Barang
                    </a>
                    <a href="<?php echo site_url('manager/member'); ?>" class="shortcut">
                        <i class="icon-smiley"></i>
                        Member
                    </a>
                    <a href="<?php echo site_url('manager/kasir'); ?>" class="shortcut">
                        <i class="icon-user"></i>
                        Kasir
                    </a>
                    <a href="<?php echo site_url('manager/profil'); ?>" class="shortcut">
                        <i class="icon-user-3"></i>
                        Profil
                    </a>
                    <a href="<?php echo site_url('manager/password'); ?>" class="shortcut">
                        <i class="icon-cog"></i>
                        Ganti Password
                    </a>
                </div>
