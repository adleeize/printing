        ...
        <div class="row border-top">
            <div class="span12 padding10 bg-grayLighter">
                <h1>
                    ...
                    <small class="on-right">Edit</small> Barang
                </h1>
                <div><p></p></div>
                <form method="post" action="<?php echo current_url(); ?>">
                    ...
                    <div class="input-control text<?php $error = form_error('nama_barang'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="Nama Barang" name="nama_barang" value="<?php echo set_value('nama_barang', $barang->nama_barang); ?>">
                        <button class="btn-clear" tabindex="-1" type="button"></button>
                        <?php echo $error; ?>
                    </div>
                    <lable>Satuan</lable>
                    <div class="input-control text<?php $error = form_error('satuan'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="Satuan" name="satuan" value="<?php echo set_value('satuan', $barang->satuan); ?>">
                        <button class="btn-clear" tabindex="-1" type="button"></button>
                        <?php echo $error; ?>
                    </div>
                    ...
                    <div class="input-control text<?php $error = form_error('harga_beli'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="Satuan" name="harga_beli" value="<?php echo set_value('harga_beli', $barang->harga_beli); ?>">
                        <button class="btn-clear" tabindex="-1" type="button"></button>
                        <?php echo $error; ?>
                    </div>
                    ...
                    <div class="input-control text<?php $error = form_error('harga_jual_biasa'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="Satuan" name="harga_jual_biasa" value="<?php echo set_value('harga_jual_biasa', $barang->harga_jual_biasa); ?>">
                        <button class="btn-clear" tabindex="-1" type="button"></button>
                        <?php echo $error; ?>
                    </div>
                    ...
                    <div class="input-control text<?php $error = form_error('harga_jual_member'); echo!empty($error) ? ' error-state' : ''; ?>" data-role="input-control">
                        <input type="text" placeholder="Satuan" name="harga_jual_member" value="<?php echo set_value('harga_jual_member', $barang->harga_jual_member); ?>">
                        <button class="btn-clear" tabindex="-1" type="button"></button>
                        <?php echo $error; ?>
                    </div>
                    <input type="submit" value="Submit" name="edit_barang">
                </form>
            </div>
        </div>
    </div>
